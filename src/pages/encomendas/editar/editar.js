...
var encomenda_recebida = document.querySelector(".encomenda_recebida");
...
var btn_recebida = document.getElementById("btn_encomenda_recebida");

encomenda_pendente.style.display = "none";
encomenda_entregar.style.display = "none";
encomenda_recebida.style.display = "none";
...
function mostra_esconde_telas(btn) {
	...
	if (btn.value == 0){
		...
		btn_recebida.style.backgroundColor = "gray";
	...
	// se foi o botão encomenda entregue foi precionado
	if (btn.value == 2) {
		encomenda_pendente.style.display = "none";
		encomenda_entregar.style.display = "none";
		encomenda_recebida.style.display = "block";
		btn_pendente.style.backgroundColor = "gray";
		btn_entregar.style.backgroundColor = "gray";
		btn_recebida.style.backgroundColor = "#17a2b8";
	}	
}
