...
if (!$apenas_branco) {
	...
	$fields = 'nome, cadastrada_morador_id, data_cadastro, previsao_data_entrega, foi_entregue';
	$arrayDados = array($encomenda_nome, $morador_logado_id, date("Y-m-d H:i:s"), $previsao_entrega, 0); //0 é o campo "foi_entregue"
